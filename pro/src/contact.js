...
function Contact(){
    return(
        <>
   <Header/>     
<section class="py-3 py-md-5 py-xl-8 contact-section">
  <div class="container">
    <div class="row justify-content-md-center">
      <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
        <h2 class="pt-5 display-5 text-center">Need Help</h2>
        ...
        <div class="card border border-dark rounded shadow-sm overflow-hidden">
          <div class="card-body p-0">
            <div class="row gy-3 gy-md-4 gy-lg-0">
              <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover contact">
                        ...
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group">
                            <span class="input-group-text">
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="c/urrentColor" class="bi bi-envelope" viewBox="0 0 16 16">
